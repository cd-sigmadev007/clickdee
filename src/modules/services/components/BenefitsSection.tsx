...
export const BenefitsSection: React.FC<BenefitsSectionProps> = ({ className = '' }) => {
  ...
  const shareInterestsCard: TextSection = {
    heading: 'Share your interests with us',
    paragraph: 'Clickdee provides exclusive, real-time fire damage leads tailored to your area, ensuring local prospects and effective scaling.',
    variant: 'bold-subtitle',
    subtitle: 'What Types of Customers and Where',
    ...
    <div className="bg-white h-full flex flex-col items-start justify-start gap-4 px-4 py-8 sm:px-6 sm:py-12 md:px-[80px] md:py-12 lg:px-[80px] lg:py-[88px] relative w-full overflow-hidden">
      <div className="relative z-10 w-full flex flex-col items-start justify-start gap-4">
        <Typography variant="h3" weight="bold" className="text-neutral-900 w-full md:text-h3 lg:text-h2">
          Avoid wasting money on clicks that don't convert
        </Typography>
        <Typography variant="p" weight="medium" className="text-neutral-600 w-full">
          Clickdee's flexible model for acquiring fire damage leads without minimum commitments, allowing budget control and attracting more customers.
        </Typography>
        <Typography variant="h4" weight="bold" className="text-neutral-900 w-full">
          Why Pay For Clicks When You Can Pay For Leads
        </Typography>
      </div>
    </div>
  );
  ...
  const trackROICard: TextSection = {
    heading: 'Track your returns on investment',
    paragraph: 'Clickdee enhances profitability with detailed ROI metrics, enabling visualization of spending-to-revenue conversions and targeted strategies.',
    variant: 'bold-subtitle',
    subtitle: 'Know Your Return to the Penny',
